(function (root, factory) {
  ...
  function normalizeOrigin(node) { return ORIGINS.has(node && node.origin) ? node.origin : 'LEGACY_UNKNOWN'; }
  ...
  function buildPacket(workspace, options) {
    ...
    return {
      schema: PACKET_SCHEMA, packet_id: packetId, hemisphere: HEMISPHERE, role: ROLE, captured_at: capturedAt,
