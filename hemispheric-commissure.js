(function(root){
'use strict';
const LOCAL='LEFT_HRAIN', PEER='RIGHT_INAIHR', ROLE='STRUCTURAL_CONTEXT';
...
async function buildExchange(packet,messageClass,payload,previousExchangeSha256=null,exchangeId=null){
 ...
 const e={schema:'janus.physarius.hemispheric_exchange.v1',exchange_id:exchangeId||`left-to-right-${Date.now()}`,source_hemisphere:LOCAL,target_hemisphere:PEER,source_packet_sha256:await sha256Hex(packet),message_class:messageClass,payload:payload||{},previous_exchange_sha256:previousExchangeSha256,control:{read_only_transfer:true,direct_cross_hemisphere_mutation:false,authority_delta:0,mass_effect_budget_delta:0,scientific_claim_promotion:false,proof_authority:false}};
...
async function acceptExchange(e){
 ...
 return Object.freeze({...e,accepted_as:'READ_ONLY_ASSOCIATIVE_CONTEXT',evidence_authority:false,independent_replication:false});
}
